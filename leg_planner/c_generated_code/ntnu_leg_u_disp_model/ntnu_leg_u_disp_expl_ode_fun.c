...
#else
  #define CASADI_PREFIX(ID) ntnu_leg_u_disp_expl_ode_fun_ ## ID
#endif
...
/* ntnu_leg_u_disp_expl_ode_fun:(i0[13],i1[3],i2[])->(o0[13]) */
...
CASADI_SYMBOL_EXPORT int ntnu_leg_u_disp_expl_ode_fun(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int ntnu_leg_u_disp_expl_ode_fun_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int ntnu_leg_u_disp_expl_ode_fun_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void ntnu_leg_u_disp_expl_ode_fun_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int ntnu_leg_u_disp_expl_ode_fun_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void ntnu_leg_u_disp_expl_ode_fun_release(int mem) {
}

CASADI_SYMBOL_EXPORT void ntnu_leg_u_disp_expl_ode_fun_incref(void) {
}

CASADI_SYMBOL_EXPORT void ntnu_leg_u_disp_expl_ode_fun_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int ntnu_leg_u_disp_expl_ode_fun_n_in(void) { return 3;}

CASADI_SYMBOL_EXPORT casadi_int ntnu_leg_u_disp_expl_ode_fun_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real ntnu_leg_u_disp_expl_ode_fun_default_in(casadi_int i){
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* ntnu_leg_u_disp_expl_ode_fun_name_in(casadi_int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* ntnu_leg_u_disp_expl_ode_fun_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* ntnu_leg_u_disp_expl_ode_fun_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* ntnu_leg_u_disp_expl_ode_fun_sparsity_out(casadi_int i) {
  switch (i) {
    case 0: return casadi_s0;
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT int ntnu_leg_u_disp_expl_ode_fun_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 3;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
